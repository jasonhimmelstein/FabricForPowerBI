...
Navigate to the "Fabric Tutorial xxx" workspace and click the "+ New item" button from the ribbon. Scroll down to the "Store data" section and select the "Eventhouse" tile. MyKusto
