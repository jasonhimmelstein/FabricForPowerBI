...
Scroll down to the "Store data" section and select the Lakehouse tile. 
...
Note the URL that appears. This could be used with the ADLS Gen 2 connector in Power BI Desktop to build a report against this data, but we will use another mechanism.
...
Select the Get data button from the ribbon, and choose "More..." at the bottom of the list. Select the "Microsoft Fabric" blade. Choose "Lakehouses" and then click the "Connect" button.
